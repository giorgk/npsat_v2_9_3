#ifndef NPSAT_V2_TRACE_POINT_IMPL_H
#define NPSAT_V2_TRACE_POINT_IMPL_H

// Existing one-characteristic tracing implementation. It remains isolated
// so atlas branching cannot change legacy ParticleHandler behavior.

template <int dim>
void NPSAT_TRACE<dim>::run_point_tracing() {
